   ...
   class GroupPanel : public ::juce::Component {
    public:
      ...
      void paint( ::juce::Graphics &g ) override {
         ...
         static constexpr ::plop::PluginMode modeVals[] = {
            ::plop::PluginMode::Drums, ::plop::PluginMode::Silica, ::plop::PluginMode::Melody
         };
         for ( int m = 0; m < 3; ++m ) {
    ...
    private:
      ...
      void drawHeaderButton( ::juce::Graphics &g, ::juce::Rectangle<int> r, const ::juce::String &label, bool active, ::juce::Colour col ) const {
      ...
      void paintControlsRow( ::juce::Graphics &g, int y ) const {
         ...
         if ( mGroup.mode == ::plop::PluginMode::Drums ) {
            ...
            g.setColour( ::juce::Colours::white );
            g.drawText( music::patternFunctionName( mGroup.pattern ), lx + 26, y, 70, CONTROLS_ROW_H, ::juce::Justification::centredLeft );
            ...
            g.setColour( ::juce::Colours::white );
            g.drawText( music::patternFunctionName( mGroup.pattern ), lx + 102, y, 70, CONTROLS_ROW_H, ::juce::Justification::centredLeft );
      ...
      void paintDrumVoices( ::juce::Graphics &g, int y ) const {
         ...
         for ( int i = 0; i < static_cast<int>( mGroup.voices.size() ); ++i ) {
            ...
            g.drawText( drumName ? ::juce::String( drumName ) : ::juce::String( voice.pitch ),
                        PAD_MD, y, 100, VOICE_ROW_H, ::juce::Justification::centredLeft );
      ...
      void paintPreview( ::juce::Graphics &g, int y ) const {
         ...
         g.setColour( colours::offWhite );
         g.drawText( "offsets: " + offsets, PAD_MD, y + PREVIEW_H / 2, getWidth() - 2 * PAD_MD, PREVIEW_H / 2, ::juce::Justification::centredLeft );
      }
      ...
      void handleControlsClick( ::juce::Point<int> pos, int /*y*/ ) {
         ...
         if ( mGroup.mode == ::plop::PluginMode::Drums ) {
            ...
            if ( pos.x >= lx + 102 && pos.x < lx + 172 ) {
               const auto &pats = mGroup.mode == ::plop::PluginMode::Silica ? music::silicaPatterns() : music::melodyPatterns();
               cyclePattern( pats );
               return;
            }
            // Note count drag
